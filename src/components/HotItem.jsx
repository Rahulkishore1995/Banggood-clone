...
<div style={{width:"90%", margin:"auto",display:"flex",gap:"20px"}} className="mt-3">
    <div style={{flex:1}}>
      <img 
      src="https://css.banggood.in/web/src/img/indexnewest/new/hot_cate2.png?v=4992b9f"
    //   {Capture}
       alt="" style={{width:"45%",height:"65%",marginLeft:'-50%'}}/>
    </div>
    <div style={{flex:1}}>
      {/* <img src="https://css.banggood.in/web/src/img/indexnewest/new/hot_cate2.png?v=4992b9f"
    //   {Capture} 
